...
import com.yinghangjiaclient.easeuiHelper.utils.ListenerManager;
import com.yinghangjiaclient.easeuiHelper.utils.PreferenceManager;
...
//                            usernickView.setText(message.getFrom());
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                //设置点击通知栏跳转事件
                Intent intent = new Intent(appContext, DemoHelper.class);
