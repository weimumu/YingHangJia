...
import com.yinghangjiaclient.weight.SampleFooter;
...
//                AppToast.showShortText(EndlessLinearLayoutActivity.this, "onItemLongClick - " + item.title);
    ...
    private static class PreviewHandler extends Handler {
        ...
        private WeakReference<TestBannerActivity> ref;

        PreviewHandler(TestBannerActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TestBannerActivity activity = ref.get();
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //模拟一下网络请求失败的情况
//                if(NetworkUtils.isNetAvailable(TestBannerActivity.this)) {
