        ...
        try {
            ...
            mRecyclerView.setLScrollListener(new LRecyclerView.LScrollListener() {
                ...
                public void onBottom() {
                    ...
                    if (hasMoreData) {
                        // loading more
                        RecyclerViewStateUtils.setFooterViewState(TestBannerActivity.this, mRecyclerView, REQUEST_COUNT, LoadingFooter.State.Loading, null);
                        new MyAsyncTask().execute();
                    } else {
                        //the end
                        RecyclerViewStateUtils.setFooterViewState(TestBannerActivity.this, mRecyclerView, REQUEST_COUNT, LoadingFooter.State.TheEnd, null);
...
//                AppToast.showShortText(EndlessLinearLayoutActivity.this, "onItemLongClick - " + item.title);
    ...
    private class DataAdapter extends ListBaseAdapter<ItemModel> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            viewHolder.banker_name.setText(item.bank);
            viewHolder.product_info.setText("理财期限" + item.cycle + "天   起投金额" + item.startMoney);
            ...
            try {
                ...
                if (!StringUtils.isBlank(result)) {
                    ...
                    if (isRefresh) {
                        ...
                        RecyclerViewStateUtils.setFooterViewState(TestBannerActivity.this, mRecyclerView, REQUEST_COUNT, LoadingFooter.State.NetWorkError, mFooterClick);
                    }
                    Toast toast = Toast.makeText(getApplicationContext(),
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (temp != null) {
                    ...
                    item.bank = bankName(temp.getString("issueBank"));
